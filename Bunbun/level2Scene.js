...
create() {
    ...
    this.Tiles = this.map2.addTilesetImage('tiledmap','tiled');

    // create the ground layer
    this.groundLayer = this.map2.createDynamicLayer('groundLayer', this.Tiles, 0, 0);

    // Set starting and ending position using name
    this.startPoint2 = this.map2.findObject("Object1", obj => obj.name === "startPoint2");
    this.endPoint2 = this.map2.findObject("Object1", obj => obj.name === "endPoint2");
    ...
    //this.add.text(30,20, 'Level 2', { font: '30px Lemon Bird', fill: '#A92C4B' }).setScrollFactor(0);
    this.add.text(30,20, 'Level 2', { font: '30px Arial Black', fill: '#A92C4B' }).setScrollFactor(0);
...
update() {
    ...
    {
        this.player.body.setVelocityX(225);
        this.player.anims.play('right', true);       
    }

    var dist = 4369 - this.player.x;
