...
create() {
    ...
    this.Tiles = this.map4.addTilesetImage('tiledmap','tiled');

    // create the ground layer
    this.groundLayer = this.map4.createDynamicLayer('groundLayer', this.Tiles, 0, 0);

    // Set starting and ending position using name
    this.startPoint3 = this.map4.findObject("Object1", obj => obj.name === "startPoint4");
    this.endPoint3 = this.map4.findObject("Object1", obj => obj.name === "endPoint4");
    ...
    //this.add.text(30,20, 'Level 4', { font: '30px Lemon Bird', fill: '#A92C4B' }).setScrollFactor(0);
    this.add.text(30,20, 'Level 4', { font: '30px Arial Black', fill: '#A92C4B' }).setScrollFactor(0);
